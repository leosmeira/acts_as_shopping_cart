  ...
  module Acts
    module ShoppingCart
      module Collection
        ...
        #
        def add(object, price, quantity = 1, cumulative = true, extra_fields={})
          cart_item = item_for(object, extra_fields)

          unless cart_item
            shopping_cart_items.create( extra_fields.merge({ :item => object, :price => price, :quantity => quantity }) )
          else
